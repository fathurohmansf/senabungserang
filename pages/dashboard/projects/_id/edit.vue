    ...
    <section class="container mx-auto pt-8">
      ...
      <div class="flex justify-between items-center">
        <div class="w-3/4 mr-6">
          <h3 class="text-2xl text-gray-900 mb-4">Edit Campaign <br> <b>{{ data.name }}</b></h3>
        </div>
              ...
              <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                  ...
                  <input
                    ...
                    v-model.number="data.goal_amount" />
                </div>
                ...
                <div class="w-full px-3">
                  <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                    What will backers get (<b>harus di ubah</b>)
                  </label>
                  <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
    ...
    async save() {
      try {
        let response = await this.$axios.$put(
          ...
          {
            // NOTED data.perks harus di ubah baru bisa ke ubah yg lain nya
            name: this.data.name,
            short_description: this.data.short_description,
            description: this.data.description,
            goal_amount: this.data.goal_amount,
