<template>
     <div class="container mx-auto h-screen flex justify-center items-center auth-page">
        <div class="w-full lg:w-1/3 px-10 lg:px-0">
          ...
          <div class="mb-4 mt-6">
            <div class="mb-3">
              <button
              :disabled="selectedFiles == undifined"
              @click="upload"
              :class="selectedFiles == undifined ? 'opacity-50 cursor-not-allowed': ''"
