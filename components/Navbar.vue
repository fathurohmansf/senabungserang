  ...
  <header class="flex items-center">
    ...
    <div class="flex ml-auto" v-else>
      <div class="dropdown inline-block relative z-10">
        ...
        <ul class="dropdown-menu absolute hidden text-greyy-700 shadow w-full -mt-2">
          <li>
           <nuxt-link to="/dashboard" class="bg-white hover:text-orange-500 py-2 px-4 block whitespace-nowrap">
            Dashboard
           </nuxt-link>
          </li>
          <li>
          ...
          <li>
           <a
           @click="logout()"
           class="cursor-pointer rounded-b bg-white hover:text-orange-500 py-2 px-4 block whitespace-now-rap">
            Logout
           </a>
          </li>
        </ul>
